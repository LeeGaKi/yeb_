<template>
  <div style="width: 900px;">
    <div>
      ...
      <el-select v-model="jl.titleLevel" placeholder
          ="职称等级" style="margin-left: 6px;margin-right: 6px">
    ...
    <div style="margin-top: 10px">
      <el-table :data="jls" stripe border @selection-change="handleSelectionChange" style="width: 100%">
      ...
      <el-button style="margin-top: 10px" :disabled="this.multipleSelection.length == 0" type="danger"
    ...
    <el-dialog title="编辑职称" :visible.sync="dialogVisible" width="30%">
      <table>
        ...
        <tr>
          ...
          <td>
            <el-select v-model="updateJl.titleLevel" placeholder="职称等级" style="margin-left: 6px;margin-right: 6px">
              <el-option v-for="item in titleLevels" :key="item" :label="item" :value="item"></el-option>
            </el-select>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <el-switch style="margin-left: 6px" v-model="updateJl.enabled" active-color="#13ce66"
                       inactive-color="#ff4949" active-text="已启用" inactive-text="未启用"></el-switch>
          </td>
        </tr>
      </table>
